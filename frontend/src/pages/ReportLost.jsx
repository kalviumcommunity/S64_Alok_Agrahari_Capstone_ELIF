...
const ReportLost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare data for API - add status as "lost" and image
      const itemData = {
        ...formData,
        status: 'lost', // Set the status as lost
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
      <h1 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
        <span className="w-8 h-8 flex items-center justify-center bg-amber-100 text-amber-500 rounded-full mr-3">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div 
            className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 ${imagePreview ? 'border-amber-300' : 'border-gray-300 border-dashed'} rounded-md`}
            onDrop={handleDrop}
        ...
        <div className="flex items-center justify-end">
          ...
          <button
            type="submit"
            className="bg-amber-500 hover:bg-amber-600 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50"
            disabled={loading || submitted}
          >
            {loading ? (
              <>
